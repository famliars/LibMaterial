...
using static LibMaterial.Framework.LibImport;
using static LibMaterial.Framework.LibImport.DwmSetWindowAttributeFlags;
using static LibMaterial.Framework.LibImport.DwmSystemBackdropTypeFlgs;

namespace LibMaterial.Framework
{
