...
namespace LibWindows
{
    public static class LibCore
    {
        ...
        [Description("")]
        public static void Apply_Extend_Frame(IntPtr HWnd, bool Disable = false)
        {
            int v = Disable ? 0 : -1;
            UxTheme.MARGINS margin = new UxTheme.MARGINS { cxLeftWidth = v, cxRightWidth = v, cyTopHeight = v, cyBottomHeight = v, };
