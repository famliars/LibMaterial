...
using static LibMaterial.NET.LibImport;
using static LibMaterial.NET.LibImport.DwmSetWindowAttributeFlags;
using static LibMaterial.NET.LibImport.DwmSystemBackdropTypeFlgs;

namespace LibMaterial.NET
{
